...
//#include "Mesh/GMSH/discreteRegion.h"
...
//#include "Mesh/GMSH/meshGRegionMMG3D.h"
...
void GModel::checkMeshCoherence(double tolerance)
{
  ...
  // check for duplicate elements
  {
	...
	Msg::Info("Done checking mesh coherence");
}

int GModel::removeDuplicateMeshVertices(double tolerance)
{
	Msg::Info("Removing duplicate mesh vertices...");
  ...
  if(num)
  {
	...
	Msg::Info("Done removing duplicate mesh vertices");
  return num;
}
...
void GModel::computeHomology()
{
  ...
  double t2 = Cpu();
  Msg::Info("Done homology and cohomology computation (%g s)",
                 t2 - t1);
