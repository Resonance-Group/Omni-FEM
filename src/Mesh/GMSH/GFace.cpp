...
#include "Mesh/GMSH/GModel.h" // Does not compile
#include "Mesh/GMSH/GFace.h" // Does not compile
#include "Mesh/GMSH/GEdge.h" // Does note compile
#include "Mesh/GMSH/MTriangle.h" // Does note compile
#include "Mesh/GMSH/MQuadrangle.h" // Does not compile
#include "Mesh/GMSH/GEdgeLoop.h"

#include "Mesh/GMSH/MElementCut.h" // This needs to be evaluated 
