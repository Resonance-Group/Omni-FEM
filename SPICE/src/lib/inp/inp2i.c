...
/*
	Parses an independent current source.
	Since SPICE2 and the input format don't support
	models for current sources, a default model is maintained
	in the INPtables structure
*/
...
void INP2I(GENERIC *ckt, INPtables *tab, card *current)
{
