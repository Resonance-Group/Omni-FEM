...
/*
	Parses a linear current controlled voltage source maintaing
	a model in the INPtables structure since the input syntax does not permit the specification of 
	a model on the input line
*/
...
void INP2H(GENERIC *ckt, INPtables *tab, card *current)
{
