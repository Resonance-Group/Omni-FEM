...
/*
	Parses a voltage controlled voltage source.
	Unlike SPICE2, SPICE3 does not support polynomial valued sources, but uses the arbitrary source instead.
	INP2E also maintains its own model since the input format does not permit one and SPICE3 requires ones
*/
...
void INP2E(GENERIC *ckt, INPtables *tab, card *current)
{
