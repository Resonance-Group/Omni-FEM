...
/*
	Parses a mutual inductor cards.
	Since mutual inductors don't have models in the SPICE2 input format,
	a default model is maintained in the INPtables structure and used for all mutual
	inductors created by this routine
*/
///<param name = "*ckt"> The curcyut circuit </param>
///<param name = "*tab"> The symbol table </param>
///<param name = "*current> The current input line </param>
void INP2K(GENERIC *ckt, INPtables *tab, card *current)
{
