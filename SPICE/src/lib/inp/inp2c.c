...
/*
	Parses a constant capacitor description, maintaining a default model in the INPtables
	structure since the SPICE2 input format does not permit a model name for a capacitor.
	SPIC3 also allows a model name to appear on the input lline, thus allowing a capacitor to be specified 
	by its size rather than by its capacitance, with the model specifying the relationship between the two.
*/
...
void INP2C(GENERIC *ckt, INPtables *tab, card *current)
{
