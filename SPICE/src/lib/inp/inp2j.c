...
/*
	Parses a JFET instance.
	Each instance must have a model specified.
	If no model with a corresponding name was found during pass 1, a model
	with the given name is created using entirely default parameter and 
	a warning message is printed
*/
///<param name = "*ckt"> The current circuit </param>
///<param name = "*tab"> Te symbol table </param>
///<param name = "*current"> The current input line </param>
void INP2J(GENERIC *ckt, INPtables *tab, card *current)
{
