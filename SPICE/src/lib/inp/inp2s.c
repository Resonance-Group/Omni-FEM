...
/*
	Parses an inpuut line for a voltage controlled ideal switch.
	Switches require a model specification, but a default switch model is maintained in case the specified model does not exist and 
	all switches using an unknown model are made instances of this model.
*/
...
void INP2S(GENERIC *ckt, INPtables *tab, card *current)
{
