...
/*
	SPerror is the predecessor of INPerror.
	SPerror is now obsolete since the front end specifies the errors associated
	with the various codes and the simulator no longer needs to provide
	translations to the messages.
*/
///<param name = "type"> NOt documented </param>
