...
/*
	Primary tokenier for the parser.
	INPgetTok finds the next token on the input
	line given and returns in token a malloc'ed character string containing a copy of just taht token.
	Token are assumed to be delimited by a reasonable set of separator characters, currently consisting of
	space, tab, comma, equals and open and close parentheses.
*/
///<param name = "**line"> Input line </param>
///<param name = "**token> Resulting token </param>
///<param name = "gobble"> Eat non-whitespace trash AFTER token? </param>
