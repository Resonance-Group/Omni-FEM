...
/*
	Performs an actual transfer function analysis.
	The code includes a partial copy of the DCop code without the output
	calls to find the operating point.
	The code to find the actual transfer function is fairly simple,
	with most of teh actual code going into output name generation
*/
///<param name = "*ckt"> Circuit to operate on </param>
///<param name = "restart> Start over or resume </param>
int TFanal(CKTcircuit *ckt, int restart)
{
    int size;
    int insrc,outsrc;
    double outputs[3];
