...
/*
	Simply stores the specified parameters into the transfer function
	analysis structure. No checking is doen to prevent specifications of both an output
	source and an output node pair but whichever is specified last will override
*/
///<param name = "*ckt"> CIrcuit to operate on </param>
///<param name = "*anal> Analysis to modify parameter of </param>
///<param name = "which"> Parameter to modify </param>
///<param name = "*value"> New value of parameter </param>
int TFsetParam(CKTcircuit *ckt, GENERIC *anal, int which, IFvalue *value)
{
	switch (which) {
