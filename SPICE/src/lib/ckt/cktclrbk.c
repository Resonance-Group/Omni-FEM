...
/*
	Used to clear a breakpoint.
	When called, it will deletethe first breakpoint in the table for the specified circuit, leaving the breakpoints
	table otherwise unchanged
*/
///<param name "*ckt"> Circuit to operate on </param>
int CKTclrBreak(register CKTcircuit *ckt)
{
	double *tmp;
	register int j;
