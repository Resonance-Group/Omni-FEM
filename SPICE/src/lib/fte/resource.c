...
///<summary> Initilizes time variable. Gets the current time in order to track how long the program is used. Essentially, starting the timer </summary>
init_time()
{
...
#  else
#    ifdef HAS_FTIME
	ftime(&timebegin);// This gets the date and time and stores it into the variable timebegin
#    endif
#  endif
#endif
