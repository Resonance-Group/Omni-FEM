...
/*
	This function is used to perform any additional intialization required by the numeric
	package which can not be performed before the setup phase of the analysis is complete.
	The vectors which are dependent on the size of the matrix, such as the RHS vector are allocated here
*/
