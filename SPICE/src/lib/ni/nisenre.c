...
/*
	Allocates all of the additional memory required by the sensitivity package that is 
	dependents on the size of the circuit and thus can not be allocated at the time the 
	sensitivity analysis is initialized
*/
