...
/*
	Is the main subroutine for performing the DC and transient NEwton-Raphson iterations.
	This routine maintains a state machine to manage the carious modes the load routines support,
	returing only when the state machine attains the proper state for exit or if the circuit 
	fails to converge.
*/
