...
/*
	This routine performs all the necessary operations to initialize a circuit to be processed later.
	The circuit structure is allocated and all default values filled in, as well as performing initialization of 
	substructures as needed.

	THis function allocates the structure necessary to describe a circuit, and sets
	*ckt to be a pointer to the newly allocated structure.
	Each succeeding call from the parser will contain this pointer as one of its arguements 
	to identify which circuit the call applies to.
*/
///<param name = "**ckt"> New circuit to create </param> 
