...
/*
	This routine assumes only two levels of nesting in te loop, although the actual analysis routine
	can handle more.
	It is also assumed that the front end will specify all of the paramters necessary for a given level
	without leaving out values
*/
//<param = *ckt> Circuit to operate on </param>
//<param = *anal> Analysis to modify parameter of </param>
//<param = which> Parameter to modify </param>
//<param = *value> New value of parameter </param>
int DCTsetParm(CKTcircuit *ckt, GENERIC *anal, int which, IFvalue *value)
{
