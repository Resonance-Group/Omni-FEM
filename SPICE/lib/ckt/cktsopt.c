...
/*
	Used to set the values of paramters to the "options" analysis in a task.
	The "options" analysis is always performed first in any task and replaces default system parameters
	with those specified in the "options" analysis. The parameters which can be set are the numerical control
	parameters which SPICE2 placed on a ".options" card and those additional parameters SPICE3 which similarly 
	apply to the entire circuit.
	The OPTinfo data structure definition and initialization is also kept in the same source file for convenience
*/
///<param name = "*ckt"> Circuit to operate on </param>
///<param name = "*anal"> Analysis/task to modify parameter of </param>
///<param name = "opt> Parameter to modify </param>
///<param name = "*val"> New value of parameter </param>
int CKTsetOpt(GENERIC *ckt, GENERIC *anal, int opt, IFvalue *val)
{
