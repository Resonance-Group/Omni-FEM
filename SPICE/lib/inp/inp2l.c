...
/*
	Parses a single inductor.
	Only simple inductors are supports and a default inductor model is 
	maintained in the INPtables structure since a model is not permitted in the input
*/
...
void INP2L(GENERIC *ckt, INPtables *tab, card *current)
{
