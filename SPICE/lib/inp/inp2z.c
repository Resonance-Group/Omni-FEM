...
/*
	Parses GaAs MESFET descriptions.
	The input format requires a model but a default is maintained in the INPtables 
	structure for all instances which refer to an unknown model.
*/
