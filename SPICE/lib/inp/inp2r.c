...
/*
	Parses a resistor instandtiation in the expanded SPICE3 format which allows for a model
	specification if desired but does not require it.
*/
...
void INP2R(GENERIC *ckt, INPtables *tab, card *current)
{
