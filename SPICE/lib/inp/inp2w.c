...
/*
	Parses current controlled switch statements.
	A default model is maintained for all instances which refer to a non-existent model
*/
///<param name = "*ckt"> The current cicuit </param>
///<param name = "*tab"> THe symbol table </param>
///<param name = "*current"> The current input line </param>
void INP2W(GENERIC *ckt, INPtables *tab, card *current)
{
