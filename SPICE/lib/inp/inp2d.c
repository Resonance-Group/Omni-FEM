...
/*
	Parses the SPICE2 description of a diode.
	Since SPICE3 relaxes the input format to the extent of making the definition of a model unnecessary,
	INP2D maintiains a defualt model definition in the INPtables structure associated with the circuit.
*/
...
void INP2D(GENERIC *ckt, INPtables *tab, card *current)
{
