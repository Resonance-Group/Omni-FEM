...
/*
	Handles specifications of independent voltage sources.
	No model is permitted in the input syntax, so a default model is maintained and
	all voltage sources are instances of it.
*/
...
void INP2V(GENERIC *ckt, INPtables *tab, card *current)
{
