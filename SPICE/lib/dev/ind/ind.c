...
IFparm INDpTable[] = { /* parameters */ 
 ...
 IP( "sens_ind",		IND_IND_SENS,			IF_FLAG, "flag to request sensitivity WRT inductance"),
 ...
 OP( "p",				IND_POWER,				IF_REAL, "instantaneous power dissipated by the inductor"),
 ...
 OPU( "sens_imag",		IND_QUEST_SENS_IMAG,	IF_REAL, "dc sensitivity and imag part of ac sensitivty"),
