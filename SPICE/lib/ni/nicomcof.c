...
/*
	Computes the timestep, order, and integration method dependent terms used in the numerical integration formulas.
	In addition to thte corrector coefficients computed by the corresponding routine in SPICE2, this routine also computes the predictor coefficients for use in the
