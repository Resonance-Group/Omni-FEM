...
/*
	Loads the complex circuit matrix with the circuit at the frrrequency currently set in the CKTcircuit structure passed, then
	performs the LU decomposition and solve, yeilding the AC solution.
	Despite what the name implies, there is no iteration in this routine, it is simply names for its
	functional correspondence to NIiter.
*/
