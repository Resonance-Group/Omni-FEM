...
/*
	This function performs the node and cirrent equation convergence tests, and in the new arrangement of device convergence testing,
	calls CKTconvTest to perform the necessary per device convergence test.
*/
