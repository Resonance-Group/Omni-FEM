...
bd_CLibDlg::bd_CLibDlg(CWnd* pParent /*=NULL*/) : CResizableDialog(bd_CLibDlg::IDD, pParent)
{
...
BOOL bd_CLibDlg::OnInitDialog()
{
	...
	LibParent = m_mytree.InsertItem(TVIF_IMAGE | TVIF_PARAM | TVIF_SELECTEDIMAGE | TVIF_TEXT | TVIF_STATE, "Library Materials", 1, 1, TVIS_EXPANDED, TVIS_EXPANDED, -9999, NULL, NULL);
	Parent = LibParent;
	ModelParent = m_mylist.InsertItem(TVIF_IMAGE | TVIF_PARAM | TVIF_SELECTEDIMAGE | TVIF_TEXT | TVIF_STATE, "Model Materials", 1, 1, TVIS_EXPANDED, TVIS_EXPANDED, -9999, NULL, NULL);
	...
	while (fgets(s, 1024, fp) != NULL)
	{
		...
		case 1:
			...
			LibProps.Add(MProp);
			m_mytree.InsertItem(TVIF_IMAGE | TVIF_PARAM | TVIF_SELECTEDIMAGE | TVIF_TEXT, MProp.BlockName, 2, 2, NULL, NULL, k, Parent, NULL);
		...
		case 2:
			...
			FoldProps.Add(FProp);
			Parent = m_mytree.InsertItem(TVIF_IMAGE | TVIF_PARAM | TVIF_SELECTEDIMAGE | TVIF_TEXT, FProp.FolderName, 0, 1, NULL, NULL, k, Parent, NULL);
...
// Code for clicking the mouse on the button
