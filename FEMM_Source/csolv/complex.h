/*
	Header File that is used to tell the program how to handle complex numbers.
	How to add, subtract, multiply, and divide complex numbers
	The complex class is declared here
*/
...
public:
	...
	// TODO: Make sure that these changes here are allowed
