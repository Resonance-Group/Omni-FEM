...
MISelectRectangle[x1_,y1_,x2_,y2_,ee_]:=MLPut["mi_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> NumC[y2] <> Num[ee] <> ")" ]; 
MISelectRectangle[x1_,y1_,x2_,y2_]:=MLPut["mi_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> Num[y2] <> ")" ]; 
...
EISelectRectangle[x1_,y1_,x2_,y2_,ee_]:=MLPut["ei_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> NumC[y2] <> Num[ee] <> ")" ]; 
EISelectRectangle[x1_,y1_,x2_,y2_]:=MLPut["ei_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> Num[y2] <> ")" ]; 
...
CISelectRectangle[x1_,y1_,x2_,y2_,ee_]:=MLPut["ci_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> NumC[y2] <> Num[ee] <> ")" ]; 
CISelectRectangle[x1_,y1_,x2_,y2_]:=MLPut["ci_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> Num[y2] <> ")" ]; 
...
HISelectRectangle[x1_,y1_,x2_,y2_,ee_]:=MLPut["hi_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> NumC[y2] <> Num[ee] <> ")" ]; 
HISelectRectangle[x1_,y1_,x2_,y2_]:=MLPut["hi_selectcircle(" <> NumC[x1] <> NumC[y1] <> NumC[x2] <> Num[y2] <> ")" ]; 
