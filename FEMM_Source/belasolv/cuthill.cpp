...
///<summary> Performs the Cuthill-McKee algorithm in renumbering DoFs </summary>
///<returns> Returns True if operation is successful </returns>
BOOL CFemmeDocCore::Cuthill()
{
	/*
		The Cuthill-McKee algorithm is an algorithm to permute a sparse matrix that has a symmetric sparsity pattern
		into a band matrix form with a small bandwidth. The algorithm relabels the vertices of the graph
		in order to reduce the bandwidth of the adjacency matrix
	*/
	FILE *fp;
	int i, j, k, n0, n1, n;
	...
	/* allocate storage. Creates empty arrays that have NumNodes elements with size int */
