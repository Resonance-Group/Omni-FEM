...
//
/* The FEMMviewView.cpp file and folder contains all of the code for the post-processor view */
#include "stdafx.h"
#include <afx.h>
#include <afxtempl.h>
#include "femm.h"
...
BOOL CFemmviewView::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
	if (zDelta < 0)
		OnZoomOut();
	else
...
/* This clicking is for clicking the mouse */
...
/* This is for the FEMM view potion. As in, this is the post-processor. THis executes everytime the Left mouse button is clicked */
